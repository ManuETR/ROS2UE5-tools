...
def create_json_file():
    ...
    iterations = int(ask_with_default("Number of iterations", "1"))
    ...
    ros2_launch = ask_with_default("ROS 2 Launch command", "pick_place_demo.launch.py")
    ros2_pkg = ask_with_default("ROS 2 Package", "moveit2_tutorials")
    timeout = int(ask_with_default("Timeout (in seconds)", "10"))
    max_sim_time = int(ask_with_default("Max simulation time (in seconds)", "60"))
